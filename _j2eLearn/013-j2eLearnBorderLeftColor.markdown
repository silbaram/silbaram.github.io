...
categories: j2eLearn
pageType: j2eLearn
date: 2016-07-26 10:24:08 +0900
lastmod: 2016-07-28 16:24:23 +0900
---
...
```
borderLeftColor: color_name|hex_number|rgb_number
```

| 속 성 | 형 식|
|---|---|
| color_name | borderLeftColor: "red" |
| hex_number | borderLeftColor: "#ff0000" |
| rgb_number | borderLeftColor: "rgb(255,0,0)" |
...
j2e.addRole({name:"role_1", role:[{share: 100, borderLeftColor:"color_name|hex_number|rgb_number"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", borderLeftColor:"red"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, borderLeftColor:"color_name|hex_number|rgb_number"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, borderLeftColor:value}]});
  }
});
</pre>
