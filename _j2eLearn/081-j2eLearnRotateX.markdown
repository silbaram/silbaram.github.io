...
> # **rotateX**
> CSS Transform rotateX 속성에 애니메이션 적용
...
j2e.addRole({name:"role_1", role:[{share: 100, rotateX:"angle"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "0", perspective: 500}, {share: "100", perspective: 500, rotateX:"180"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, rotateX:"angle"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, perspective: 500, rotateX:value}]});
  }
});
</pre>
