...
lastmod: 2016-07-28 16:28:56 +0900
---
...
j2e.addRole({name:"role_1", role:[{share: 100, borderLeftWidth:"length"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", borderLeftWidth:"50"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, borderLeftWidth:"length"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, borderLeftWidth:value}]});
  }
});
</pre>
