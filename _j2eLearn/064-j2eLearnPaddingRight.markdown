...
categories: j2eLearn
pageType: j2eLearn
date: 2016-07-27 18:00:58 +0900
lastmod: 2016-07-30 16:52:36 +0900
---
...
| 속 성 | 형 식|
|---|---|
| length \| percentage | paddingRight: "Xpx \| X%" |
...
j2e.addRole({name:"role_1", role:[{share: 100, paddingRight:"length | percentage"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", paddingRight:"50%"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, paddingRight:"length | percentage"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, paddingRight:value}]});
  }
});
</pre>
