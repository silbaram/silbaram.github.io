...
lastmod: 2016-07-30 15:51:54 +0900
---

> # **outlineOffset**
> CSS outline-offset 속성에 애니메이션 적용
...
j2e.addRole({name:"role_1", role:[{share: 100, outlineOffset:"length"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", outlineOffset:"10px"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, outlineOffset:"length"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, outlineOffset:value}]});
  }
});
</pre>
