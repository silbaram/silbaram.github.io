...
lastmod: 2016-07-30 17:20:32 +0900
---
...
j2e.addRole({name:"role_1", role:[{share: 100, top:"length | percentage"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", top:"90"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, top:"length | percentage"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, top:value}]});
  }
});
</pre>
