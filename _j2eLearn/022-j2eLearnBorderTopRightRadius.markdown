...
lastmod: 2016-07-26 13:48:18 +0900
---
...
j2e.addRole({name:"role_1", role:[{share: 100, borderTopRightRadius:"변경값"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, borderTopRightRadius:"변경값"}]});
</pre>
