...
lastmod: 2016-07-29 14:12:34 +0900
---

> # **borderTopWidth**
> CSS border-top-width 속성에 애니메이션 적용
...
j2e.addRole({name:"role_1", role:[{share: 100, borderTopWidth:"length"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", bottom:"450"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, borderTopWidth:"length"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, borderTopWidth:value}]});
  }
});
</pre>
