...
lastmod: 2016-07-28 16:32:32 +0900
---

> # **borderRight**
> CSS border-right 속성에 애니메이션 적용
...
```
borderRight: borderWidth border-style [borderColor]
```

| 속 성 | 형 식|
|---|---|
| borderWidth border-style [borderColor] | borderRight: "Xpx solid [red]" |
| borderWidth border-style [borderColor] | borderRight: "Xpx solid []#ff0000]" |
| borderWidth border-style [borderColor] | borderRight: "Xpx solid [rgb(255,0,0)]" |
...
j2e.addRole({name:"role_1", role:[{share: 100, borderRight:"borderWidth border-style [borderColor]"}]});
...
* #### 예제소스
<pre class="prettyprint linenums:1">
j2e.addRole({name:"role_1", role:[{share: "100", borderRight:"15px solid red"}]});
...
<pre class="prettyprint linenums:1">
j2e(elements).animate({role:[{duration: 1, borderRight:"borderWidth border-style [borderColor]"}]});
</pre>
...
$(document).ready(function(){
  ...
  $("#trasitionButton").click(function(){
    ...
    j2e("#trasitionButton").animate({role:[{duration: 1, borderRight:value}]});
});
</pre>
